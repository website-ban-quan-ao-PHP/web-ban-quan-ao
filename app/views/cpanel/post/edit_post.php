...
<h3 style="text-align: center;"> Chỉnh sửa bài viết</h3>
 	...
 	<form action="<?php echo BASE_URL?>/post/update_post/<?php echo $pos['id_post'] ?>" method="POST" enctype="multipart/form-data" >
 		<div class="form-group">
  		...
  		<div class="form-group">
   	 		...
   	 		<input type="file" value="<?php echo $pos['image_post'] ?>" name="image_post" class="form-control" >
		...
		<div class="form-group">
	  	...
	  	<button type="submit" name="updatepost" class="btn btn-default">Chỉnh sửa bài viết</button>
	</form>
